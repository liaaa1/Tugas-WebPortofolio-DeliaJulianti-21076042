...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="{{ Storage::url($jumbotron->thumbail) }}" alt="..." />
        <!-- Masthead Heading-->
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal{{ $i }}">
              ...
              <img class="img-fluid" src="{{ Storage::url($item->thumbail) }}" alt="..." />
            </div>
          </div>
          <!-- last partner {{ $i }}-->
          @php
    ...
    <section class="page-section bg-primary text-white mb-0" id="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-3 ms-auto text-center"><img src="{{ Storage::url($about->thumbail) }}"
            class="w-75" /></div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 mb-5 mb-lg-0">
            ...
            <p class="mt-2">Untuk informasi lebih lanjut, silakan lihat CV saya.</p>
            <!-- Button to download CV -->
            <a class="btn btn-primary btn-sm" href="https://drive.google.com/file/d/1p4ywTcjHKj9mG8ZfTRPVRcQ_LmafWf9Y/view?usp=sharing" target="_blank">
        ...
        <div class="col-lg-3 mb-5 mb-lg-0">
          ...
          @if ($email)
            <a class="btn btn-outline-light btn-social mx-1" href="mailto:{{ $email }}" target="_blank"><i class="fas fa-envelope"></i></a>
          @endif
    ...
    <div class="copyright py-4 text-center text-white">
      <div class="container"><small>Copyright &copy; Delia Julianti 2024</small></div>
    </div>
    <!-- Partner Modals-->
    @php
        $i=1;
              ...
              <div class="container">
                <div class="row justify-content-center">
                  <div class="col-lg-8">
                    ...
                    <!-- Partner Modal - Image-->
                    <img class="img-fluid rounded mb-5" src="{{ Storage::url($item->thumbail) }}" alt="..." />
                    <!-- Partner Modal - Text-->
                   {!! $item->content !!}
                   <div class="m-5">
